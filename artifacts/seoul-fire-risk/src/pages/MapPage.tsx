          ...
          {(["관심", "주의", "경계", "위험"] as RiskLevel[]).map((level) => (
            <div key={level} className="flex items-center gap-2">
              <div
                ...
                style={{ backgroundColor: getRiskColor(level), opacity: 0.85 }}
              />
              ...
              {popup && (
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <span
                      className={`px-2 py-0.5 rounded-full text-sm font-bold text-white ${getRiskBg(popup.riskLevel)}`}
                    >
                      {popup.riskLevel}
                    </span>
                  </div>
                  ...
                  <Link href={`/district/${popup.name}`} className="block">
            ...
            return (
              <Link key={shape.name} href={`/district/${shape.name}`}>
                <div
                  ...
                  data-testid={`list-district-${shape.name}`}
